...
export default function Home({ navItem, setNavItem }) {
  ...
  const ServiceCard = ({ img, title, subTitle }) => {
    return (
      <div data-aos="fade-up" className="serviceCard">
        <img src={img} />
        <p>{title}</p>
        <span>{subTitle}</span>
      </div>
  ...
  const TrustCard = ({ header, subHeader, icon }) => {
    return (
      <div data-aos="fade-up" className="trustCard">
        <img src={icon} />
  ...
  return (
    <>
      ...
      <div
        id="grayBox"
        style={{ display: searchPop ? "flex" : "none" }}
        className="garyBox"
        onClick={closePop}
      >
        <div className="searchPopBox">
          ...
          <div className="searchPopBoxInput">
            ...
            <DropBox
              icon={locationIcon}
              label="location"
              setDropVal={setlocationDropVal}
              dropList={LocationList}
            />
          </div>
          <div className="searchPopBoxInput">
            ...
            <DropBox
              ...
              setDropVal={setDropVal3}
              dropList={PropertyType}
            />
          </div>
          <div style={{ marginBottom: "50px" }} className="searchPopBoxInput">
            ...
            <DropBox
              icon={propertyIcon}
              label="Property Size"
              setDropVal={setDropVal1}
              dropList={PropertySize}
            />
          </div>
          <WhiteBtn
            btnText="SEARCH"
      ...
      <div className="homeContainer">
        <div className="homeTopSection">
          ...
          <p className="homeSubHeader">
            India's best home advisory & property transaction platform
          </p>
          <div className="MobileHomeBtnBox">
            <BlackBtn
              width="100%"
              icon={searchIcon}
              btnText="Search properties..."
              onClick={() => {
                setSearchPop(true);
              }}
            />
          ...
          <div className="HomeBtnBox">
            ...
            <DropBox
              icon={dollerIcon}
              label="Budget"
              setDropVal={setDropVal2}
              dropList={PropertyBudget}
            />
            <BlackBtn
              icon={searchIcon}
              btnText="SEARCH"
        ...
        <div className="serviceSection">
          ...
          <div className="serviceCardBox">
            <ServiceCard
              img={serviceImg1}
              title="Residential"
              subTitle="Lorem ipsum dolor sit amet consectetur. Nunc odio nec massa egestas egestas. Id purus quam volutpat."
            />
            <ServiceCard
              img={serviceImg2}
              title="Commercial"
              subTitle="Lorem ipsum dolor sit amet consectetur. Consectetur amet ac faucibus porttitor et in massa."
            />
            <ServiceCard
              img={serviceImg3}
              title="Industrial"
              subTitle="Lorem ipsum dolor sit amet consectetur. Felis duis neque velit duis lectus tincidunt tortor amet."
            />
          </div>
        ...
        <div className="aboutNbsSection">
          ...
          <p data-aos="fade-up" className="SectionHeader">What Is NBS Property?</p>

          <div className="anbs">
            <div data-aos="fade-up" className="nbsImgBox">
            ...
            <div className="nbsTextBox">
              <p data-aos="fade-up" className="SectionHeader">Who We Are</p>
              <p data-aos="fade-up" className="sectionSubText">
                Lorem ipsum dolor sit amet consectetur. Consequat et est varius
                a leo. In id fringilla sagittis eu. Nec et lorem gravida rhoncus
                eget egestas tortor augue blandit. Suspendisse lacus morbi diam
                dui diam mi justo ut.
              </p>
              <p data-aos="fade-up" className="sectionSubText">
                Arcu ultrices luctus tincidunt dui nibh ante urna. Vel felis
                nunc in tincidunt non vitae dui. Proin tristique aenean morbi
                risus ultrices amet. Nunc proin massa sed laoreet euismod a
                magna at. Suspendisse nibh dolor elit commodo lectus commodo.
                Habitant nunc risus gravida in odio. Ut nunc amet in cursus
                malesuada augue amet pellentesque. Tortor nulla est ornare
                augue. Proin.
              </p>
        ...
        <div className="trustSection">
          <div className="trustBox">
            <div className="trustInBox">
              <TrustCard
                icon={trust1}
                header="Trust Section 1"
                subHeader="Lorem ipsum dolor sit amet consectetur. Morbi mauris blandit enim nisl. Purus facilisi bibendum magna consequat. Odio nec."
              />
              <TrustCard
                icon={trust2}
                header="Trust Section 2"
                subHeader="Lorem ipsum dolor sit amet consectetur. Pellentesque integer libero amet gravida eu elementum faucibus amet faucibus. Cursus."
              />
              <TrustCard
                icon={trust3}
                header="Trust Section 3"
                subHeader="Lorem ipsum dolor sit amet consectetur. Metus duis lacus tincidunt tortor. Ipsum non sociis tellus tortor urna proin orci ultrices."
              />
              <TrustCard
                icon={trust4}
                header="Trust Section 4"
                subHeader="Lorem ipsum dolor sit amet consectetur. Vestibulum mollis lacus faucibus gravida sed viverra donec nisl donec. Risus non neque."
              />
            </div>
            <div className="wmDifferent">
              <p data-aos="fade-up" className="wmDfHeader">What Make Us Different?</p>
              <p data-aos="fade-up" className="sectionSubText">
                Lorem ipsum dolor sit amet consectetur. Diam scelerisque
                sollicitudin tristique enim integer sed nunc ultricies nisi.
                Urna lacinia tempor lacus placerat velit.
              </p>
              ...
              <img data-aos="fade-up" src={difBgImg} />
            </div>
          </div>
          ...
          <div className="NearUSection">
            ...
            <div className="nearLoCardBox">
              {nearYouPropertie?.map((el, i) => (
                <div data-aos="fade-up" key={el} className="nearLoCard">
                  <p>{el.num}+</p>
                  <span>{el.sum}</span>
        ...
        <div className="AbelPropt">
          <p data-aos="fade-up" className="SectionHeader">Available Properties Near You</p>
          <p data-aos="fade-up" className="sectionSubText">
            Industrial development is our main line of business. We do Factory
            Construction, Warehouse and others
          </p>
        ...
        <div className="BlogSection">
          <p data-aos="fade-up" className="SectionHeader">Our Blogs</p>
          <p data-aos="fade-up" className="sectionSubText">
            Industrial development is our main line of business. We do Factory
            Construction, Warehouse and others
          </p>
